...
contracts_idx = [
                    ...
                    "create index usaspending_contract_agency_name_ft on usaspending_contract using gin(to_tsvector('federal_spending', agency_name));",
                    "create index usaspending_contract_contracting_agency_name_ft on usaspending_contract using gin(to_tsvector('federal_spending', contracting_agency_name));",
                    "create index usaspending_contract_requesting_agency_name_ft on usaspending_contract using gin(to_tsvector('federal_spending', requesting_agency_name));",
                    "create index usaspending_contract_vendor_city_ft on usaspending_contract using gin(to_tsvector('federal_spending', city));",
                    "create index usaspending_contract_vendor_name_ft on usaspending_contract using gin(to_tsvector('federal_spending', vendorname));",
...
grants_idx = [
                ...
                "create index usaspending_grant_agency_name_ft on usaspending_grant using gin(to_tsvector('federal_spending', agency_name));",
                "create index usaspending_grant_recipient_name_ft on usaspending_grant using gin(to_tsvector('federal_spending', recipient_name));",
