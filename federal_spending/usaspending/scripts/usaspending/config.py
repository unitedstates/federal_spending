INDEX_COLS_BY_TABLE = {
    'usaspending_contract': [
        ...
        'using gin (to_tsvector(\'federal_spending\'::regconfig, contracting_agency_name::text))',
        '(fiscal_year DESC, obligatedamount DESC)',
        'dunsnumber',
        'obligatedamount',
        'piid',
        'using gin (to_tsvector(\'federal_spending\'::regconfig, requesting_agency_name::text))',
        'signeddate',
        'using gin (to_tsvector(\'federal_spending\'::regconfig, city::text))',
